...
*Healthcare IT & Information Security Audit Programme v1.0 · Reference ITA-202607-FCAA*
...
<sub>Prepared by A. Tony, Lead IT Auditor · Northgate Health Group · Report reference ITA-202607-FCAA. This report is issued for the internal use of management and the audit committee. It reflects the control environment observed during the audit period and does not constitute a guarantee that all weaknesses have been identified.</sub>

<sub>Generated with the [Healthcare IT Audit Tool](https://github.com/ajaytony1411-ajse/healthcare-it-audit-tool--10) · © 2026 Ajay Tony · MIT licence.</sub>
